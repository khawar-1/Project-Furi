...
8. FACTS SUBJECT AND PERSPECTIVES: For each entry in "facts_about_user":
   ...
   - In fact_user_perspective, wrap every person's name in {{CONTACT:...}} using the name as said. In fact_contact_perspective, refer to the user as {{USER}} and to every OTHER involved person as {{CONTACT:name-as-said}}. {{USER}} means the user ONLY — never write {{USER}} for a contact. Example for "me, Ali and Sam went hiking yesterday": fact_user_perspective = 'Went hiking with {{CONTACT:Ali}} and {{CONTACT:Sam}} on 2026-07-05', fact_contact_perspective = 'Went hiking with {{USER}} and {{CONTACT:Sam}} on 2026-07-05'.
