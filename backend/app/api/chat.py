...
_IMPERSONATION_CORRECTION = (
    ...
    "no message was sent, no web search happened, no reminder or calendar event "
    "was created, and nothing was changed. To actually do this, say it as a "
    'direct instruction, e.g. "delete the .txt files in my Downloads folder", '
    '"email Jamil about dinner", or "search the web for when the next season '
    'comes out".'
)
