...
const navItems: NavItem[] = [
  ...
  { id: 'routines', icon: <Repeat size={20} />, label: 'Routines', phase: 6 },
  { id: 'initiative', icon: <Sparkles size={20} />, label: 'Suggestions', phase: 9 },
  { id: 'threads', icon: <Target size={20} />, label: 'Threads', phase: 11 },
  { id: 'agents', icon: <Bot size={20} />, label: 'Agents', phase: 4 },
